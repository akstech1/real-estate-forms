...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h1 class="h4 mb-0">Add New Partner</h1>
                <p class="text-muted small mb-0">Create a new business partner</p>
            </div>
                            ...
                            <div class="color-inputs">
                                <div class="input-group">
                                    ...
                                    <input type="color" class="form-control form-control-color @error('background_colour') is-invalid @enderror" 
                                           id="background_colour" name="background_colour" value="{{ old('background_colour', '#ffffff') }}" required>
                                    <input type="text" class="form-control" value="{{ old('background_colour', '#ffffff') }}" 
