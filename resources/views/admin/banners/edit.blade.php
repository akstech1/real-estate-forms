                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('short_description_en') is-invalid @enderror" 
                                              id="short_description_en" name="short_description_en" rows="3">{{ old('short_description_en', $banner->short_description_en) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('button_text_en') is-invalid @enderror" 
                                           id="button_text_en" name="button_text_en" value="{{ old('button_text_en', $banner->button_text_en) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('short_description_ar') is-invalid @enderror" 
                                              id="short_description_ar" name="short_description_ar" rows="3">{{ old('short_description_ar', $banner->short_description_ar) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('button_text_ar') is-invalid @enderror" 
                                           id="button_text_ar" name="button_text_ar" value="{{ old('button_text_ar', $banner->button_text_ar) }}">
                                    ...
                                    @if($banner->banner_image_url)
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <img src="{{ $banner->banner_image_url }}" alt="Current Banner" 
