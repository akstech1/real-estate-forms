...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h1 class="h4 mb-0">FAQ Banner Image</h1>
                <p class="text-muted small mb-0">Manage the banner image for the FAQ section</p>
            </div>
...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('dashboard.faqs.banner.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    
                                         <div class="mb-4">
                         <label for="banner_image" class="form-label">FAQ Banner Image *</label>
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                                   @if($faqBanner && $faqBanner->banner_image_url)
                   <div class="text-center">
                       <img src="{{ $faqBanner->banner_image_url }}" 
                            alt="Current FAQ Banner" 
                            class="img-fluid rounded mb-3" 
                            style="max-width: 100%; height: auto;">
                       
                       <div class="d-grid gap-2">
                           <a href="{{ $faqBanner->banner_image_url }}" 
                              target="_blank" 
                        ...
                        <div class="mt-3">
                            <small class="text-muted">
                                <i class="fas fa-info-circle me-1"></i>
                                This image will be displayed at the top of your FAQ page
                            </small>
                        </div>
                    </div>
                @else
                    <div class="text-center py-4">
                        ...
                        <p class="text-muted small mb-0">
                            Upload an image to set as your FAQ banner
                        </p>
                    </div>
                @endif
            </div>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <ul class="list-unstyled mb-0">
                    ...
                    <li class="mb-2">
                        <i class="fas fa-check-circle text-success me-2"></i>
                        Consider using images that represent FAQs
                    </li>
                    <li class="mb-0">
                        <i class="fas fa-check-circle text-success me-2"></i>
