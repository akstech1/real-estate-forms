...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h1 class="h4 mb-0">Add New Testimonial</h1>
                <p class="text-muted small mb-0">Create a new customer testimonial</p>
            </div>
...
<div class="card">
    <div class="card-header">
        <h6 class="card-title mb-0">
            <i class="fas fa-plus me-2 text-primary"></i>Testimonial Information
        </h6>
    </div>
    <div class="card-body">
        <form action="{{ route('dashboard.testimonials.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('short_description_en') is-invalid @enderror" 
                                  ...
                                  rows="4" 
                                  required>{{ old('short_description_en') }}</textarea>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('short_description_ar') is-invalid @enderror" 
                                  ...
                                  rows="4" 
                                  required>{{ old('short_description_ar') }}</textarea>
                        <div class="form-text">Maximum 1000 characters</div>
            ...
            <div class="mb-4">
                ...
                <input type="file" 
                       ...
                       required>
                <div class="form-text">
                    Accepted formats: JPEG, PNG, JPG, WebP. Maximum size: 2MB.
                </div>
                @error('image')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
